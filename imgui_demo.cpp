            ...
            if (ImGui::TreeNode("Usage Scenarios"))
            {
                ...
                if (ImGui::TreeNode("5. Claiming CTRL+A shortcut globally"))
                {
                    ...
                    if (enable_ctrl_a_robbery)
                        ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiKey_A, 0, ImGuiInputFlags_RouteGlobalHighest);
                ...
                if (ImGui::TreeNode("7. Claiming ESC away from an InputText()"))
                {
                    ...
                    if (ImGui::IsItemActive())
                    {
                        ...
                        if (ImGui::Shortcut(ImGuiKey_Escape, robber_id, ImGuiInputFlags_RouteGlobalHighest))
                        {
                            strcpy(buf, "Esc!");
                            ImGui::ClearActiveID();
                        }
                ...
                if (ImGui::TreeNode("9. Claiming Tab, CTRL+Tab"))
                {
                    ...
                    case 6:
                    {
                        ...
                        //ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiKey_Tab, id, ImGuiInputFlags_RouteGlobalHighest);
                        //ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab, id, ImGuiInputFlags_RouteGlobalHighest);
                        if (ImGui::Shortcut(ImGuiMod_Ctrl | ImGuiKey_Tab, id, ImGuiInputFlags_RouteGlobalHighest))
                            counter++; // You could perform some other action here.
                        if (ImGui::Shortcut(ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab, id, ImGuiInputFlags_RouteGlobalHighest))
                            counter--;
                        break;
                    }
                    case 7:
